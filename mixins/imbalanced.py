...
from imblearn.over_sampling import (
    SMOTE, BorderlineSMOTE, RandomOverSampler, KMeansSMOTE, SVMSMOTE, SMOTENC
)
from imblearn.under_sampling import (
    CondensedNearestNeighbour, EditedNearestNeighbours, NearMiss, AllKNN,
    RepeatedEditedNearestNeighbours, InstanceHardnessThreshold, TomekLinks,
...
class ImbalancedMixin():
    ...
    def sampling_techniques(self, oversampling, undersampling):
        ...
        if oversampling and undersampling:
            ...
            sampling_techniques = ["ros", "borderlinesmote", "kmeanssmote",
                                   "svmsmote", "smote"]
        elif undersampling:
            sampling_techniques = ["cnn", "enn", "renn", "aknn", "iht",
                                   "nearmiss", "ncr", "oss", "rus",
                                   "tomelinks"]
